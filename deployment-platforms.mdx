...
<CardGroup cols={2}>
  ...
  <Card title="Authentication" icon="shield" href="/configuration">
    Secure your deployment
  </Card>
  <Card title="Docker Guide" icon="docker" href="/deploy-as-app">
    Detailed Docker deployment guide
  </Card>
  <Card title="Kubernetes" icon="server" href="/deployment-platforms">
